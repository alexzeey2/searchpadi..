        ...
        <div className="fixed inset-0 bg-[#1a1a1a] z-50 flex flex-col overflow-hidden">
            <div className="bg-[#1a1a1a] p-4 border-b border-gray-800 flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {!isOwnProfile && (
                        <div className="relative w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-white flex-shrink-0">
                            ...
                            {(seller.leadsCount || 0) > 0 && (
                                <span className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full text-[10px] font-bold flex items-center justify-center text-white">
                                    {(seller.leadsCount || 0) > 9 ? '9+' : seller.leadsCount}
                                </span>
                            )}
                        </div>
                    )}
